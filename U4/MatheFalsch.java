...
public class MatheFalsch {
  ...
  public static void eingabe() {
    ...
    while (sc.hasNext()) {
      a = sc.nextInt(); c = sc.nextInt();
      b = sc.nextInt(); d = sc.nextInt();
      System.out.println("Eingabe: " + a + " " + b + " " + c + " " + d);
      System.out.println("Minimum: " + min(a, d, c, b));
      System.out.println("Mittelwert: " + mean(a, b, c, d));
      System.out.println("am naechsten am Mittelwert: " + nextToMean(a, b, c, d));
    }
    sc.close();
  }
